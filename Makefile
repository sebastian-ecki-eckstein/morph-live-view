...
# translation
SOURCES = morph_live_view.py ui_morph_live_view.py __init__.py morph_live_viewdialog.py
#TRANSLATIONS = i18n/morph_live_view_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = morph_live_view

PY_FILES = morph_live_view.py morph_live_viewdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_morph_live_view.py
